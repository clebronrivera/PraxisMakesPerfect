          ...
          return (
            <button
              ...
              className={`w-full text-left flex items-start gap-3 p-2.5 rounded-lg border text-sm transition-colors
                ${isSelected
                  ? 'border-amber-300/50 bg-[color:#d97706]/10 text-amber-900'
                  : 'border-slate-200 bg-slate-50 text-slate-700 hover:border-[color:#d97706]/40 hover:bg-amber-50'
                }
            ...
            >
              <span
                className={`shrink-0 w-5 h-5 rounded-${isMultiSelect ? 'sm' : 'full'} border-2 flex items-center justify-center mt-0.5
                  ${isSelected ? 'border-[color:#d97706] bg-[color:#d97706]/80' : 'border-slate-300'}
                `}
              >
                {isSelected && (
                  isMultiSelect
