...
export function TutorChatPage({
  ...
  return (
    <div className="flex h-full min-h-0 text-slate-200" style={{ fontFamily: "'Inter', system-ui, sans-serif" }}>
      ...
      {/* ══════ LEFT: sessions ══════ */}
      <aside className="w-64 shrink-0 border-r border-slate-200 flex flex-col bg-[rgba(6,13,26,0.45)] backdrop-blur-md">
        <div className="p-4 flex items-center justify-between">
          ...
          <button
            ...
            title="New chat"
            className="w-7 h-7 rounded-full border border-white/15 text-white flex items-center justify-center hover:border-[color:#d97706] transition-colors focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-amber-500"
          >
        ...
        <div className="px-4 pb-3">
          <div className="flex p-0.5 rounded-full border border-slate-200 bg-[rgba(6,13,26,0.6)]">
            <button
      ...
      <section className="flex-1 flex flex-col min-h-0 relative z-10">
        ...
        <div className="px-4 pb-4 flex-shrink-0">
          <div className="flex items-end gap-3 p-3.5 rounded-2xl bg-[rgba(6,13,26,0.85)] border border-white/12 focus-within:border-amber-300/50 focus-within:ring-2 focus-within:ring-[color:#d97706]/20 transition-colors">
            <textarea
              ref={inputRef}
              value={input}
      ...
      <aside className="hidden xl:flex w-[300px] shrink-0 border-l border-slate-200 flex-col overflow-y-auto p-3 gap-3 bg-[rgba(6,13,26,0.3)]">

        <div className="rounded-xl p-4 bg-[rgba(10,22,40,0.4)] border border-slate-200">
          ...
          {artifactsInSession.length === 0 ? (
            ...
            <div className="space-y-2">
              {artifactsInSession.slice(0, 6).map((m) => (
                <div key={m.id} className="flex items-start gap-2 p-2 rounded-lg hover:bg-white cursor-pointer">
                  <div
        ...
        <div className="rounded-xl p-4 border" style={{ borderColor: 'rgba(252,213,180,0.25)', background: 'rgba(252,213,180,0.04)' }}>
          <p className="text-[10px] tracking-[0.22em] uppercase font-semibold mb-2" style={{ color: '#d97706' }}>Suggestion</p>
