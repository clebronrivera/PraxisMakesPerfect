...
export const progressToMetadataId: Record<string, string> = {
  ...
  'ACA-06': 'ACAD-S06',                    // Learning Theories → behaviorism, constructivism, ZPD, scaffolding, information processing
  ...
  'DEV-01': 'NEW-4-DevelopmentalInterventions',  // Development (Erikson, Piaget) → developmental appropriateness, Piaget stages, cognitive development
  ...
  'DIV-05': 'DIV-S08',                     // Special Education Services & Diverse Needs → LRE, continuum of services, culturally responsive special education
  ...
  'LEG-03': 'NEW-10-EducationLaw',         // Section 504 / ADA → Section 504, IDEA, civil rights access
...
// Every runtime skill now maps to a DISTINCT metadata entry — the two former
// shared mappings were split on 2026-06-02 by authoring ACAD-S06 (for ACA-06)
// and DIV-S08 (for DIV-05). The reverse map is therefore 1:1; toProgressId()
// is currently unused at runtime.
