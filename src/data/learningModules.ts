...
export const LEARNING_MODULES: LearningModule[] = [
...

  {
    ...
    sections: [
      { type: 'anchor', label: 'Stage sequence + ESSA anchor', text: "Implementation stages: Dissemination → Adoption → Initial Implementation → Full Implementation. 'Goodness of fit' belongs to Dissemination. ESSA evidence tiers evaluate PROGRAMS (Tier 1 = RCT). MTSS tiers organize STUDENTS. (Note: the Fixsen/NIRN framework labels the first stage 'Exploration' — a different name for the same fit-analysis stage. Both models describe the same pre-adoption gate.)" },
