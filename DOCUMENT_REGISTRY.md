...
| `AUTHENTICATION_STATUS.md` | Merge into master report | Historical | Archive to `archive/docs-legacy-2026-03-14/` | `FIREBASE_AUTH_SETUP.md`, `README.md` | Yes | Status snapshot, not durable documentation. |
...
| `DEPLOY_FIREBASE_RULES.md` | Canonical source | Active | Keep in root | Self | No | Active Firestore rules deployment guide. |
...
| `FIREBASE_AUTH_SETUP.md` | Canonical source | Active | Keep in root | Self | No | Active Firebase auth console setup guide. |
...
| `FIREBASE_SECURITY_TESTING.md` | Canonical source | Active | Keep in root | Self | Partial | Active testing guide; examples should be validated when Firebase APIs change. |
...
| `FIX_UNAUTHORIZED_DOMAIN.md` | Canonical source | Active | Keep in root | Self | No | Active troubleshooting guide for Firebase auth domain issues. |
...
| `QUICK_AUTH_SETUP.md` | Archive as historical | Superseded | Archive to `archive/docs-legacy-2026-03-14/` | `FIREBASE_AUTH_SETUP.md` | Yes | Short duplicate of the canonical auth setup guide. |
